...
export default function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <div className="flex flex-col w-full h-full rounded-lg shadow-sm hover:shadow-md transition-all duration-100 border-t-2 border-l-2 border-r-2 border-gray-100 gap-2 cursor-pointer">
      ...
      <div className="flex items-center justify-between w-full h-full pb-4 px-4 ">
        ...
        <Button 
          size="sm" 
          className="md:text-[14px] text-black font-[600] rounded-md bg-white border-gray-300 border-1 hover:text-white hover:bg-primary hover:border-primary transition-all duration-100"
        >
          Записаться
        </Button>
      </div>
